package dev.noctud.latte.syntaxHighlighter;
...
public class LatteColorSettingsPage implements ColorSettingsPage {
    private static final AttributesDescriptor[] DESCRIPTORS = new AttributesDescriptor[]{
        ...
        new AttributesDescriptor("Link destination", LatteSyntaxHighlighter.MACRO_LINK),
        new AttributesDescriptor("File path", LatteSyntaxHighlighter.MACRO_FILE_PATH),
        new AttributesDescriptor("Control name", LatteSyntaxHighlighter.MACRO_CONTROL),
